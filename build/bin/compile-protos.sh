...
protoc -I=$proto_imports --gogofaster_out=Mgoogle/protobuf/timestamp.proto=github.com/gogo/protobuf/types,Mconfig/store/change/change.proto=github.com/onosproject/onos-config/pkg/store/change,import_path=github.com/onosproject/onos-config/pkg/store/config,plugins=grpc:. pkg/store/config/*.proto
