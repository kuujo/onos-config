...
protoc -I=$proto_imports --gogofaster_out=Mgoogle/protobuf/timestamp.proto=github.com/gogo/protobuf/types,import_path=github.com/onosproject/onos-config/pkg/types/device/snapshot,plugins=grpc:. pkg/types/device/snapshot/*.proto
...
protoc -I=$proto_imports --gogofaster_out=Mgoogle/protobuf/timestamp.proto=github.com/gogo/protobuf/types,import_path=github.com/onosproject/onos-config/pkg/types/network/snapshot,plugins=grpc:. pkg/types/network/snapshot/*.proto
