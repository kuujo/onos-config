...
require (
	...
	github.com/onosproject/onos-config-model v0.4.2
...
replace github.com/onosproject/onos-config-model => github.com/kuujo/onos-config-model v0.0.2-0.20210309220037-921400df7473
